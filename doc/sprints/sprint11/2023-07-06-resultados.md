### Como resultado do andamento da sprint, foi possível concluir todas as issues planejadas. Foram criados os pipelines de integração contínua e implementada a página de configurações.
#
