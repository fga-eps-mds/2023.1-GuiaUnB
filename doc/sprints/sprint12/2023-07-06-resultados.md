### Como resultado do andamento da sprint, foi implementado a tela de Onboarding apenas na primeira execução do app, o botão de envio de email para relatar bugs e o GitHub Pages da documentação do projeto.
#
