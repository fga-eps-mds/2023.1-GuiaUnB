...
| US06 | Como um usuário que já conhece o aplicarivo, eu quero ter acesso rápido às informações mais relevantes do aplicativo, sem precisar passar por telas desnecessárias. | Must       | 3      |
...
| US11 | Como usuário, quero ser capaz de pesquisar por palavras-chave ou frases para encontrar informações específicas dentro do aplicativo.                     | Should     | 4      |
...
| ID   | User Story                                                                                                                                             | Prioridade | Pontos |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------ |
| US15 | Como Usuário, gostaria de saber o que fazer em situações de assédio dentro da universidade.                                                            | Must       | 2      |
| US16 | Como aluno da UnB, gostaria de receber informações sobre como relatar a discordância do método disciplinar de algum docente.                           | Must       | 2      |
| US17 | Como aluno da UnB, gostaria de saber como fazer para conectar na internet do campus.                                                                   | Must       | 2      |
| US18 | Como aluno da UnB, eu gostaria de ter acesso fácil a informações sobre as disciplinas oferecidas.                                                      | Must       | 2      |
| US19 | Como visitante, eu quero poder acessar informações sobre eventos e palestras na UnB para que eu possa participar e aprender mais sobre a universidade. | Should     | 3      |
| US20 | Como aluno da UnB, desejo receber dicas de saúde mental e como conseguir ajuda.                                                                        | Should     | 8      |
