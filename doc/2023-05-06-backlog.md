...
| ID   | User Story                                                                                                                                             | Prioridade | Pontos |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------ |
| US23 | Como Usuário, gostaria de ter um ChatBot assistente que consiga tirar minha dúvidas ou me oferecer a informações que eu desejo de maneira mais rápida                                                         | Won't       | 24      |
